# Módulo Comercial, Contratos, Tarifas y Bonos
...
Ruta: Admin → Comercial → Tarifas y Bonos
...
Ruta: Admin → Comercial → Promociones
...
Ruta: Admin → Comercial → Contratos
...
Ruta: Panel usuario → Comprar bonos
